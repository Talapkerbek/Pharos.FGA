...
public static class MinimalApiExtensions
{
    ...
    /// <returns>The <see cref="T:Microsoft.AspNetCore.Builder.IEndpointConventionBuilder" />.</returns>
    public static TBuilder WithFgaStringObject<TBuilder>(this TBuilder builder, string relation, string @object) where TBuilder : IEndpointConventionBuilder
    {
        return builder.WithMetadata(new FgaStringObjectAttribute(relation, @object));
    }
